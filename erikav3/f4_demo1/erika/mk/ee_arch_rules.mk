...
OS_EE_LINKER_SCRIPT := $(OS_EE_SRC_BASE_DIR)/STM32H743XIHx_FLASH.ld
endif # OS_EE_ARCH_CORTEX_M_STM32H7
...
$(TARGET_NAME).bin: $(TARGET_NAME).elf
	$(VERBOSE_PRINTBIN) $(EE_OBJCOPY) -O binary $(SOURCEFILE) $(TARGETFILE)
