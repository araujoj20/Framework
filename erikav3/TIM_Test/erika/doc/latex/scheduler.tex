\doxysection{ERIKA3 and real-\/time scheduling }
\hypertarget{scheduler}{}\label{scheduler}\index{ERIKA3 and real-\/time scheduling@{ERIKA3 and real-\/time scheduling}}
...
Tasks in ERIKA3 are scheduled according to fixed priorities, and share resources using the Immediate Priority Ceiling protocol.
...
The scheduling policy of ERIKA3 is a Fixed Priority Scheduling with Immediate Priority Ceiling. As a result, the following case of tasks may be implemented\+:
