...
################################################################################
OPT_CC += -c -mthumb -mno-thumb-interwork
...
ifeq	($(call iseeopt, OS_EE_ARCH_CORTEX_M_STM32H7), yes)
# FB: FPU Support
ifneq	($(call iseeopt, OS_EE_ARCH_CORTEX_M_M7F_FPU), yes)
OPT_CC += -mfloat-abi=soft
else	# OS_EE_ARCH_CORTEX_M_M7F_FPU
OPT_CC += -mfloat-abi=hard -mfpu=fpv5-sp-d16
endif	# OS_EE_ARCH_CORTEX_M_M7F_FPU

ifeq	($(or							\
  $(call iseeopt, OS_EE_ARCH_CORTEX_M_M7),			\
  $(or								\
	$(call iseeopt, OS_EE_ARCH_CORTEX_M_M7F),		\
	$(call iseeopt, OS_EE_ARCH_CORTEX_M_M7F_FPU)		\
  )								\
), yes)
OPT_CC += -mcpu=cortex-m7
OPT_CC += -DSTM32H753xx
endif	#
	# OS_EE_ARCH_CORTEX_M_M7	||
	# OS_EE_ARCH_CORTEX_M_M7F	||
	# OS_EE_ARCH_CORTEX_M_M7F_FPU
	#
endif
...
ifneq	($(call iseeopt, OS_EE_GCC_MINIMAL_OPTS), yes)
OPT_CC += -fdata-sections -ffunction-sections -fmessage-length=0
OPT_CC += -mapcs -fno-common -ffreestanding -fno-builtin -fno-exceptions
OPT_CC += -fno-strict-aliasing -nostartfiles
...
################################################################################
OPT_CXX += -c -mthumb -mno-thumb-interwork
...
ifneq	($(call iseeopt, OS_EE_GCC_MINIMAL_OPTS), yes)
OPT_CXX += -ffunction-sections -fdata-sections -fmessage-length=0
OPT_CXX += -mapcs -fno-common -ffreestanding -fno-builtin -fno-exceptions
OPT_CXX += -fno-strict-aliasing -nostartfiles -fno-rtti
endif	# OS_EE_CORTEX_M_MCU
...
################################################################################
OS_EE_AS_OPT += -c -x assembler-with-cpp -mthumb -mno-thumb-interwork
...
OS_EE_AS_OPT += -mfloat-abi=hard -mfpu=fpv5-sp-d16
endif	# OS_EE_ARCH_CORTEX_M_M7F_FPU
ifeq	($(or							\
  $(call iseeopt, OS_EE_ARCH_CORTEX_M_M7),			\
  $(or								\
...
#ifneq	($(call iseeopt, OS_EE_GCC_MINIMAL_OPTS), yes)
OS_EE_AS_OPT += -ffunction-sections -fdata-sections -fmessage-length=0
OS_EE_AS_OPT += -mapcs -fno-common -ffreestanding -fno-builtin -fno-exceptions
OS_EE_AS_OPT += -fno-strict-aliasing -nostartfiles -fno-rtti
#endif	# OS_EE_GCC_MINIMAL_OPTS
...
################################################################################
OPT_LINK += -mthumb -mno-thumb-interwork
...
OPT_LINK += -mfloat-abi=hard -mfpu=fpv5-sp-d16
endif	# OS_EE_ARCH_CORTEX_M_M7F_FPU
ifeq	($(or							\
  $(call iseeopt, OS_EE_ARCH_CORTEX_M_M7),			\
  $(or								\
