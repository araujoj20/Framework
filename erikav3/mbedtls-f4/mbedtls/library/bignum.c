...
//     // //MBEDTLS_MPI_CHK(mbedtls_mpi_write_string(&A, radix, s, sizeof(s) - 2, &n));
//     // //my_printf("Converted value (A): %s\n", s);
//     // my_printf("A->p = ");
//     // for (size_t i = 0; i < A.n; i++) {
//     //     my_printf("%" PRIx64, (mbedtls_ct_uint_t)A.p[i]);
//     // }
//     // my_printf("\n");

//     // my_printf("A->s = 0x%" PRIx16 "\n", A.s);
//     // my_printf("A->n = 0x%" PRIx16 "\n", A.n);
...
//     // MBEDTLS_MPI_CHK(mbedtls_mpi_write_string(&A_TEST, radix, s, sizeof(s) - 2, &n));
//     // my_printf("Converted value (A): %s\n", s);
...
//     my_printf("X->s 0x%" PRIx16 "\n", X.s);
//     my_printf("X->n 0x%" PRIx16 "\n", X.n);
//     my_printf("X->p = ");
//     for (size_t i = 0; i < X.n; i++) {
//         my_printf("%" PRIx64, (mbedtls_ct_uint_t)X.p[i]);
//     }
//     my_printf("\n");
...
//     MBEDTLS_MPI_CHK(mbedtls_mpi_write_string(&X, radix, s, sizeof(s) - 2, &n));
//     my_printf("Converted value (X): %64s\n", s);
...
//     my_printf("U->s 0x%" PRIx16 "\n", U.s);
//     my_printf("U->n 0x%" PRIx16 "\n", U.n);
//     my_printf("U->p = ");
//     for (size_t i = 0; i < U.n; i++) {
//         my_printf("%" PRIx64, (mbedtls_ct_uint_t)U.p[i]);
//     }
//     my_printf("\n");
...
//    									"101FDE3D9BA02E23A79196E7B50B5CE1" \
//										"2A0AC16C4A0EDC5BE97F79845EEFEC6B" \
//										"6B0186AD1DAE8CC887F34F247F19E551" \
//										"837322393A3955214CB14C75D0BF2F19"));
    ...
    MBEDTLS_MPI_CHK(mbedtls_mpi_read_string(&X, 16,
                                        "0036E139AEA55215609D2816998ED020" \
                                        "BBBD96C37890F65171D948E9BC7CBAA4" \
                                        "D9325D24D6A3C12710F10A09FA08AB87"));
