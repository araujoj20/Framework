...
/home/araujoj20/Documents/GitHub/Framework/Test/st/test2/build/test2.elf:     file format elf32-littlearm
...
080001fc <__do_global_dtors_aux>:
 ...
 8000220:	080049b0 	.word	0x080049b0
...
08000224 <frame_dummy>:
 ...
 8000244:	080049b0 	.word	0x080049b0
...
08000248 <__libc_init_array>:
 ...
 800025c:	f004 fba8 	bl	80049b0 <_init>
 ...
 8000280:	08004a00 	.word	0x08004a00
 8000284:	08004a00 	.word	0x08004a00
 8000288:	08004a00 	.word	0x08004a00
 800028c:	08004a04 	.word	0x08004a04
...
08000460 <_write_r>:
 ...
 8000470:	f000 fc4d 	bl	8000d0e <_write>
...
080004d8 <_close_r>:
 ...
 80004e4:	f000 fc2f 	bl	8000d46 <_close>
...
08000794 <_lseek_r>:
 ...
 80007a4:	f000 faf6 	bl	8000d94 <_lseek>
...
080007b8 <_read_r>:
 ...
 80007c8:	f000 fa84 	bl	8000cd4 <_read>
...
080007f4 <_sbrk_r>:
 ...
 8000800:	f000 fad6 	bl	8000db0 <_sbrk>
...
08000a2c <main>:
 ...
 8000a5e:	f003 ff15 	bl	800488c <puts>
 8000a62:	bf00      	nop
 8000a64:	e7fd      	b.n	8000a62 <main+0x36>
 8000a66:	bf00      	nop
 8000a68:	080049c8 	.word	0x080049c8
...
08000a78 <SystemClock_Config>:
 ...
 8000a88:	f7ff fd1a 	bl	80004c0 <memset>
...
08000db0 <_sbrk>:
 ...
 8000de0:	f003 fd5c 	bl	800489c <__errno>
...
08002364 <DMA_CalcBaseAndBitshift>:
 ...
 80023cc:	080049f0 	.word	0x080049f0
...
08002cf0 <HAL_RCC_ClockConfig>:
 ...
 8002eb0:	080049d8 	.word	0x080049d8
...
080030e0 <HAL_RCC_GetPCLK1Freq>:
 ...
 8003104:	080049e8 	.word	0x080049e8
...
08003108 <HAL_RCC_GetPCLK2Freq>:
 ...
 800312c:	080049e8 	.word	0x080049e8
...
080043d2 <LoopFillZerobss>:
 ...
 80043d6:	f7fb ff37 	bl	8000248 <__libc_init_array>
 ...
 80043ec:	08004a08 	.word	0x08004a08
...
080043fc <__udivmoddi4>:
 ...
 8004406:	d14e      	bne.n	80044a6 <__udivmoddi4+0xaa>
 8004408:	4694      	mov	ip, r2
 800440a:	458c      	cmp	ip, r1
 800440c:	4686      	mov	lr, r0
 800440e:	fab2 f282 	clz	r2, r2
 8004412:	d962      	bls.n	80044da <__udivmoddi4+0xde>
 8004414:	b14a      	cbz	r2, 800442a <__udivmoddi4+0x2e>
 8004416:	f1c2 0320 	rsb	r3, r2, #32
 800441a:	4091      	lsls	r1, r2
 800441c:	fa20 f303 	lsr.w	r3, r0, r3
 8004420:	fa0c fc02 	lsl.w	ip, ip, r2
 8004424:	4319      	orrs	r1, r3
 8004426:	fa00 fe02 	lsl.w	lr, r0, r2
 800442a:	ea4f 471c 	mov.w	r7, ip, lsr #16
 800442e:	fa1f f68c 	uxth.w	r6, ip
 8004432:	fbb1 f4f7 	udiv	r4, r1, r7
 8004436:	ea4f 431e 	mov.w	r3, lr, lsr #16
 800443a:	fb07 1114 	mls	r1, r7, r4, r1
 800443e:	ea43 4301 	orr.w	r3, r3, r1, lsl #16
 8004442:	fb04 f106 	mul.w	r1, r4, r6
 8004446:	4299      	cmp	r1, r3
 8004448:	d90a      	bls.n	8004460 <__udivmoddi4+0x64>
 800444a:	eb1c 0303 	adds.w	r3, ip, r3
 800444e:	f104 30ff 	add.w	r0, r4, #4294967295	@ 0xffffffff
 8004452:	f080 8112 	bcs.w	800467a <__udivmoddi4+0x27e>
 8004456:	4299      	cmp	r1, r3
 8004458:	f240 810f 	bls.w	800467a <__udivmoddi4+0x27e>
 800445c:	3c02      	subs	r4, #2
 800445e:	4463      	add	r3, ip
 8004460:	1a59      	subs	r1, r3, r1
 8004462:	fa1f f38e 	uxth.w	r3, lr
 8004466:	fbb1 f0f7 	udiv	r0, r1, r7
 800446a:	fb07 1110 	mls	r1, r7, r0, r1
 800446e:	ea43 4301 	orr.w	r3, r3, r1, lsl #16
 8004472:	fb00 f606 	mul.w	r6, r0, r6
 8004476:	429e      	cmp	r6, r3
 8004478:	d90a      	bls.n	8004490 <__udivmoddi4+0x94>
 800447a:	eb1c 0303 	adds.w	r3, ip, r3
 800447e:	f100 31ff 	add.w	r1, r0, #4294967295	@ 0xffffffff
 8004482:	f080 80fc 	bcs.w	800467e <__udivmoddi4+0x282>
 8004486:	429e      	cmp	r6, r3
 8004488:	f240 80f9 	bls.w	800467e <__udivmoddi4+0x282>
 800448c:	4463      	add	r3, ip
 800448e:	3802      	subs	r0, #2
 8004490:	1b9b      	subs	r3, r3, r6
 8004492:	ea40 4004 	orr.w	r0, r0, r4, lsl #16
 8004496:	2100      	movs	r1, #0
 8004498:	b11d      	cbz	r5, 80044a2 <__udivmoddi4+0xa6>
 800449a:	40d3      	lsrs	r3, r2
 800449c:	2200      	movs	r2, #0
 800449e:	e9c5 3200 	strd	r3, r2, [r5]
 80044a2:	e8bd 87f0 	ldmia.w	sp!, {r4, r5, r6, r7, r8, r9, sl, pc}
 80044a6:	428b      	cmp	r3, r1
 80044a8:	d905      	bls.n	80044b6 <__udivmoddi4+0xba>
 80044aa:	b10d      	cbz	r5, 80044b0 <__udivmoddi4+0xb4>
 80044ac:	e9c5 0100 	strd	r0, r1, [r5]
 80044b0:	2100      	movs	r1, #0
 80044b2:	4608      	mov	r0, r1
 80044b4:	e7f5      	b.n	80044a2 <__udivmoddi4+0xa6>
 80044b6:	fab3 f183 	clz	r1, r3
 80044ba:	2900      	cmp	r1, #0
 80044bc:	d146      	bne.n	800454c <__udivmoddi4+0x150>
 80044be:	42a3      	cmp	r3, r4
 80044c0:	d302      	bcc.n	80044c8 <__udivmoddi4+0xcc>
 80044c2:	4290      	cmp	r0, r2
 80044c4:	f0c0 80f0 	bcc.w	80046a8 <__udivmoddi4+0x2ac>
 80044c8:	1a86      	subs	r6, r0, r2
 80044ca:	eb64 0303 	sbc.w	r3, r4, r3
 80044ce:	2001      	movs	r0, #1
 80044d0:	2d00      	cmp	r5, #0
 80044d2:	d0e6      	beq.n	80044a2 <__udivmoddi4+0xa6>
 80044d4:	e9c5 6300 	strd	r6, r3, [r5]
 80044d8:	e7e3      	b.n	80044a2 <__udivmoddi4+0xa6>
 80044da:	2a00      	cmp	r2, #0
 80044dc:	f040 8090 	bne.w	8004600 <__udivmoddi4+0x204>
 80044e0:	eba1 040c 	sub.w	r4, r1, ip
 80044e4:	ea4f 481c 	mov.w	r8, ip, lsr #16
 80044e8:	fa1f f78c 	uxth.w	r7, ip
 80044ec:	2101      	movs	r1, #1
 80044ee:	fbb4 f6f8 	udiv	r6, r4, r8
 80044f2:	ea4f 431e 	mov.w	r3, lr, lsr #16
 80044f6:	fb08 4416 	mls	r4, r8, r6, r4
 80044fa:	ea43 4304 	orr.w	r3, r3, r4, lsl #16
 80044fe:	fb07 f006 	mul.w	r0, r7, r6
 8004502:	4298      	cmp	r0, r3
 8004504:	d908      	bls.n	8004518 <__udivmoddi4+0x11c>
 8004506:	eb1c 0303 	adds.w	r3, ip, r3
 800450a:	f106 34ff 	add.w	r4, r6, #4294967295	@ 0xffffffff
 800450e:	d202      	bcs.n	8004516 <__udivmoddi4+0x11a>
 8004510:	4298      	cmp	r0, r3
 8004512:	f200 80cd 	bhi.w	80046b0 <__udivmoddi4+0x2b4>
 8004516:	4626      	mov	r6, r4
 8004518:	1a1c      	subs	r4, r3, r0
 800451a:	fa1f f38e 	uxth.w	r3, lr
 800451e:	fbb4 f0f8 	udiv	r0, r4, r8
 8004522:	fb08 4410 	mls	r4, r8, r0, r4
 8004526:	ea43 4304 	orr.w	r3, r3, r4, lsl #16
 800452a:	fb00 f707 	mul.w	r7, r0, r7
 800452e:	429f      	cmp	r7, r3
 8004530:	d908      	bls.n	8004544 <__udivmoddi4+0x148>
 8004532:	eb1c 0303 	adds.w	r3, ip, r3
 8004536:	f100 34ff 	add.w	r4, r0, #4294967295	@ 0xffffffff
 800453a:	d202      	bcs.n	8004542 <__udivmoddi4+0x146>
 800453c:	429f      	cmp	r7, r3
 800453e:	f200 80b0 	bhi.w	80046a2 <__udivmoddi4+0x2a6>
 8004542:	4620      	mov	r0, r4
 8004544:	1bdb      	subs	r3, r3, r7
 8004546:	ea40 4006 	orr.w	r0, r0, r6, lsl #16
 800454a:	e7a5      	b.n	8004498 <__udivmoddi4+0x9c>
 800454c:	f1c1 0620 	rsb	r6, r1, #32
 8004550:	408b      	lsls	r3, r1
 8004552:	fa22 f706 	lsr.w	r7, r2, r6
 8004556:	431f      	orrs	r7, r3
 8004558:	fa20 fc06 	lsr.w	ip, r0, r6
 800455c:	fa04 f301 	lsl.w	r3, r4, r1
 8004560:	ea43 030c 	orr.w	r3, r3, ip
 8004564:	40f4      	lsrs	r4, r6
 8004566:	fa00 f801 	lsl.w	r8, r0, r1
 800456a:	0c38      	lsrs	r0, r7, #16
 800456c:	ea4f 4913 	mov.w	r9, r3, lsr #16
 8004570:	fbb4 fef0 	udiv	lr, r4, r0
 8004574:	fa1f fc87 	uxth.w	ip, r7
 8004578:	fb00 441e 	mls	r4, r0, lr, r4
 800457c:	ea49 4404 	orr.w	r4, r9, r4, lsl #16
 8004580:	fb0e f90c 	mul.w	r9, lr, ip
 8004584:	45a1      	cmp	r9, r4
 8004586:	fa02 f201 	lsl.w	r2, r2, r1
 800458a:	d90a      	bls.n	80045a2 <__udivmoddi4+0x1a6>
 800458c:	193c      	adds	r4, r7, r4
 800458e:	f10e 3aff 	add.w	sl, lr, #4294967295	@ 0xffffffff
 8004592:	f080 8084 	bcs.w	800469e <__udivmoddi4+0x2a2>
 8004596:	45a1      	cmp	r9, r4
 8004598:	f240 8081 	bls.w	800469e <__udivmoddi4+0x2a2>
 800459c:	f1ae 0e02 	sub.w	lr, lr, #2
 80045a0:	443c      	add	r4, r7
 80045a2:	eba4 0409 	sub.w	r4, r4, r9
 80045a6:	fa1f f983 	uxth.w	r9, r3
 80045aa:	fbb4 f3f0 	udiv	r3, r4, r0
 80045ae:	fb00 4413 	mls	r4, r0, r3, r4
 80045b2:	ea49 4404 	orr.w	r4, r9, r4, lsl #16
 80045b6:	fb03 fc0c 	mul.w	ip, r3, ip
 80045ba:	45a4      	cmp	ip, r4
 80045bc:	d907      	bls.n	80045ce <__udivmoddi4+0x1d2>
 80045be:	193c      	adds	r4, r7, r4
 80045c0:	f103 30ff 	add.w	r0, r3, #4294967295	@ 0xffffffff
 80045c4:	d267      	bcs.n	8004696 <__udivmoddi4+0x29a>
 80045c6:	45a4      	cmp	ip, r4
 80045c8:	d965      	bls.n	8004696 <__udivmoddi4+0x29a>
 80045ca:	3b02      	subs	r3, #2
 80045cc:	443c      	add	r4, r7
 80045ce:	ea43 400e 	orr.w	r0, r3, lr, lsl #16
 80045d2:	fba0 9302 	umull	r9, r3, r0, r2
 80045d6:	eba4 040c 	sub.w	r4, r4, ip
 80045da:	429c      	cmp	r4, r3
 80045dc:	46ce      	mov	lr, r9
 80045de:	469c      	mov	ip, r3
 80045e0:	d351      	bcc.n	8004686 <__udivmoddi4+0x28a>
 80045e2:	d04e      	beq.n	8004682 <__udivmoddi4+0x286>
 80045e4:	b155      	cbz	r5, 80045fc <__udivmoddi4+0x200>
 80045e6:	ebb8 030e 	subs.w	r3, r8, lr
 80045ea:	eb64 040c 	sbc.w	r4, r4, ip
 80045ee:	fa04 f606 	lsl.w	r6, r4, r6
 80045f2:	40cb      	lsrs	r3, r1
 80045f4:	431e      	orrs	r6, r3
 80045f6:	40cc      	lsrs	r4, r1
 80045f8:	e9c5 6400 	strd	r6, r4, [r5]
 80045fc:	2100      	movs	r1, #0
 80045fe:	e750      	b.n	80044a2 <__udivmoddi4+0xa6>
 8004600:	f1c2 0320 	rsb	r3, r2, #32
 8004604:	fa20 f103 	lsr.w	r1, r0, r3
 8004608:	fa0c fc02 	lsl.w	ip, ip, r2
 800460c:	fa24 f303 	lsr.w	r3, r4, r3
 8004610:	4094      	lsls	r4, r2
 8004612:	430c      	orrs	r4, r1
 8004614:	ea4f 481c 	mov.w	r8, ip, lsr #16
 8004618:	fa00 fe02 	lsl.w	lr, r0, r2
 800461c:	fa1f f78c 	uxth.w	r7, ip
 8004620:	fbb3 f0f8 	udiv	r0, r3, r8
 8004624:	fb08 3110 	mls	r1, r8, r0, r3
 8004628:	0c23      	lsrs	r3, r4, #16
 800462a:	ea43 4301 	orr.w	r3, r3, r1, lsl #16
 800462e:	fb00 f107 	mul.w	r1, r0, r7
 8004632:	4299      	cmp	r1, r3
 8004634:	d908      	bls.n	8004648 <__udivmoddi4+0x24c>
 8004636:	eb1c 0303 	adds.w	r3, ip, r3
 800463a:	f100 36ff 	add.w	r6, r0, #4294967295	@ 0xffffffff
 800463e:	d22c      	bcs.n	800469a <__udivmoddi4+0x29e>
 8004640:	4299      	cmp	r1, r3
 8004642:	d92a      	bls.n	800469a <__udivmoddi4+0x29e>
 8004644:	3802      	subs	r0, #2
 8004646:	4463      	add	r3, ip
 8004648:	1a5b      	subs	r3, r3, r1
 800464a:	b2a4      	uxth	r4, r4
 800464c:	fbb3 f1f8 	udiv	r1, r3, r8
 8004650:	fb08 3311 	mls	r3, r8, r1, r3
 8004654:	ea44 4403 	orr.w	r4, r4, r3, lsl #16
 8004658:	fb01 f307 	mul.w	r3, r1, r7
 800465c:	42a3      	cmp	r3, r4
 800465e:	d908      	bls.n	8004672 <__udivmoddi4+0x276>
 8004660:	eb1c 0404 	adds.w	r4, ip, r4
 8004664:	f101 36ff 	add.w	r6, r1, #4294967295	@ 0xffffffff
 8004668:	d213      	bcs.n	8004692 <__udivmoddi4+0x296>
 800466a:	42a3      	cmp	r3, r4
 800466c:	d911      	bls.n	8004692 <__udivmoddi4+0x296>
 800466e:	3902      	subs	r1, #2
 8004670:	4464      	add	r4, ip
 8004672:	1ae4      	subs	r4, r4, r3
 8004674:	ea41 4100 	orr.w	r1, r1, r0, lsl #16
 8004678:	e739      	b.n	80044ee <__udivmoddi4+0xf2>
 800467a:	4604      	mov	r4, r0
 800467c:	e6f0      	b.n	8004460 <__udivmoddi4+0x64>
 800467e:	4608      	mov	r0, r1
 8004680:	e706      	b.n	8004490 <__udivmoddi4+0x94>
 8004682:	45c8      	cmp	r8, r9
 8004684:	d2ae      	bcs.n	80045e4 <__udivmoddi4+0x1e8>
 8004686:	ebb9 0e02 	subs.w	lr, r9, r2
 800468a:	eb63 0c07 	sbc.w	ip, r3, r7
 800468e:	3801      	subs	r0, #1
 8004690:	e7a8      	b.n	80045e4 <__udivmoddi4+0x1e8>
 8004692:	4631      	mov	r1, r6
 8004694:	e7ed      	b.n	8004672 <__udivmoddi4+0x276>
 8004696:	4603      	mov	r3, r0
 8004698:	e799      	b.n	80045ce <__udivmoddi4+0x1d2>
 800469a:	4630      	mov	r0, r6
 800469c:	e7d4      	b.n	8004648 <__udivmoddi4+0x24c>
 800469e:	46d6      	mov	lr, sl
 80046a0:	e77f      	b.n	80045a2 <__udivmoddi4+0x1a6>
 80046a2:	4463      	add	r3, ip
 80046a4:	3802      	subs	r0, #2
 80046a6:	e74d      	b.n	8004544 <__udivmoddi4+0x148>
 80046a8:	4606      	mov	r6, r0
 80046aa:	4623      	mov	r3, r4
 80046ac:	4608      	mov	r0, r1
 80046ae:	e70f      	b.n	80044d0 <__udivmoddi4+0xd4>
 80046b0:	3e02      	subs	r6, #2
 80046b2:	4463      	add	r3, ip
 80046b4:	e730      	b.n	8004518 <__udivmoddi4+0x11c>
 80046b6:	bf00      	nop
...
080046b8 <__swbuf_r>:
 ...
 80046c6:	f7fb fe6f 	bl	80003a8 <__sinit>
 80046ca:	69a3      	ldr	r3, [r4, #24]
 80046cc:	60a3      	str	r3, [r4, #8]
 80046ce:	89a3      	ldrh	r3, [r4, #12]
 80046d0:	071a      	lsls	r2, r3, #28
 80046d2:	d501      	bpl.n	80046d8 <__swbuf_r+0x20>
 80046d4:	6923      	ldr	r3, [r4, #16]
 80046d6:	b943      	cbnz	r3, 80046ea <__swbuf_r+0x32>
 80046d8:	4621      	mov	r1, r4
 80046da:	4628      	mov	r0, r5
 80046dc:	f000 f82a 	bl	8004734 <__swsetup_r>
 80046e0:	b118      	cbz	r0, 80046ea <__swbuf_r+0x32>
 ...
 80046ee:	1a98      	subs	r0, r3, r2
 80046f0:	6963      	ldr	r3, [r4, #20]
 80046f2:	b2f6      	uxtb	r6, r6
 80046f4:	4283      	cmp	r3, r0
 80046f6:	4637      	mov	r7, r6
 80046f8:	dc05      	bgt.n	8004706 <__swbuf_r+0x4e>
 80046fa:	4621      	mov	r1, r4
 80046fc:	4628      	mov	r0, r5
 80046fe:	f7fb ff7f 	bl	8000600 <_fflush_r>
 8004702:	2800      	cmp	r0, #0
 8004704:	d1ed      	bne.n	80046e2 <__swbuf_r+0x2a>
 ...
 8004712:	701e      	strb	r6, [r3, #0]
 8004714:	6962      	ldr	r2, [r4, #20]
 8004716:	1c43      	adds	r3, r0, #1
 8004718:	429a      	cmp	r2, r3
 800471a:	d004      	beq.n	8004726 <__swbuf_r+0x6e>
 800471c:	89a3      	ldrh	r3, [r4, #12]
 800471e:	07db      	lsls	r3, r3, #31
 8004720:	d5e1      	bpl.n	80046e6 <__swbuf_r+0x2e>
 8004722:	2e0a      	cmp	r6, #10
 8004724:	d1df      	bne.n	80046e6 <__swbuf_r+0x2e>
 8004726:	4621      	mov	r1, r4
 8004728:	4628      	mov	r0, r5
 800472a:	f7fb ff69 	bl	8000600 <_fflush_r>
 800472e:	2800      	cmp	r0, #0
 8004730:	d0d9      	beq.n	80046e6 <__swbuf_r+0x2e>
 8004732:	e7d6      	b.n	80046e2 <__swbuf_r+0x2a>

08004734 <__swsetup_r>:
 8004734:	b538      	push	{r3, r4, r5, lr}
 8004736:	4b29      	ldr	r3, [pc, #164]	@ (80047dc <__swsetup_r+0xa8>)
 ...
 8004744:	f7fb fe30 	bl	80003a8 <__sinit>
 8004748:	f9b4 300c 	ldrsh.w	r3, [r4, #12]
 800474c:	0719      	lsls	r1, r3, #28
 800474e:	d422      	bmi.n	8004796 <__swsetup_r+0x62>
 8004750:	06da      	lsls	r2, r3, #27
 8004752:	d407      	bmi.n	8004764 <__swsetup_r+0x30>
 ...
 8004762:	e033      	b.n	80047cc <__swsetup_r+0x98>
 8004764:	0758      	lsls	r0, r3, #29
 8004766:	d512      	bpl.n	800478e <__swsetup_r+0x5a>
 8004768:	6b61      	ldr	r1, [r4, #52]	@ 0x34
 800476a:	b141      	cbz	r1, 800477e <__swsetup_r+0x4a>
 800476c:	f104 0344 	add.w	r3, r4, #68	@ 0x44
 8004770:	4299      	cmp	r1, r3
 8004772:	d002      	beq.n	800477a <__swsetup_r+0x46>
 8004774:	4628      	mov	r0, r5
 8004776:	f7fc f84d 	bl	8000814 <_free_r>
 ...
 8004798:	b94b      	cbnz	r3, 80047ae <__swsetup_r+0x7a>
 800479a:	89a3      	ldrh	r3, [r4, #12]
 800479c:	f403 7320 	and.w	r3, r3, #640	@ 0x280
 80047a0:	f5b3 7f00 	cmp.w	r3, #512	@ 0x200
 80047a4:	d003      	beq.n	80047ae <__swsetup_r+0x7a>
 80047a6:	4621      	mov	r1, r4
 80047a8:	4628      	mov	r0, r5
 80047aa:	f000 f8a3 	bl	80048f4 <__smakebuf_r>
 80047ae:	f9b4 300c 	ldrsh.w	r3, [r4, #12]
 80047b2:	f013 0201 	ands.w	r2, r3, #1
 80047b6:	d00a      	beq.n	80047ce <__swsetup_r+0x9a>
 80047b8:	2200      	movs	r2, #0
 80047ba:	60a2      	str	r2, [r4, #8]
 80047bc:	6962      	ldr	r2, [r4, #20]
 80047be:	4252      	negs	r2, r2
 80047c0:	61a2      	str	r2, [r4, #24]
 80047c2:	6922      	ldr	r2, [r4, #16]
 80047c4:	b942      	cbnz	r2, 80047d8 <__swsetup_r+0xa4>
 80047c6:	f013 0080 	ands.w	r0, r3, #128	@ 0x80
 80047ca:	d1c5      	bne.n	8004758 <__swsetup_r+0x24>
 80047cc:	bd38      	pop	{r3, r4, r5, pc}
 80047ce:	0799      	lsls	r1, r3, #30
 80047d0:	bf58      	it	pl
 80047d2:	6962      	ldrpl	r2, [r4, #20]
 80047d4:	60a2      	str	r2, [r4, #8]
 80047d6:	e7f4      	b.n	80047c2 <__swsetup_r+0x8e>
 80047d8:	2000      	movs	r0, #0
 80047da:	e7f7      	b.n	80047cc <__swsetup_r+0x98>
...
080047e0 <_puts_r>:
 ...
 80047ea:	b90b      	cbnz	r3, 80047f0 <_puts_r+0x10>
 80047ec:	f7fb fddc 	bl	80003a8 <__sinit>
 80047f0:	6e63      	ldr	r3, [r4, #100]	@ 0x64
 80047f2:	07db      	lsls	r3, r3, #31
 80047f4:	d405      	bmi.n	8004802 <_puts_r+0x22>
 80047f6:	89a3      	ldrh	r3, [r4, #12]
 80047f8:	0598      	lsls	r0, r3, #22
 80047fa:	d402      	bmi.n	8004802 <_puts_r+0x22>
 80047fc:	6da0      	ldr	r0, [r4, #88]	@ 0x58
 80047fe:	f7fb fe68 	bl	80004d2 <__retarget_lock_acquire_recursive>
 8004802:	89a3      	ldrh	r3, [r4, #12]
 8004804:	0719      	lsls	r1, r3, #28
 8004806:	d502      	bpl.n	800480e <_puts_r+0x2e>
 8004808:	6923      	ldr	r3, [r4, #16]
 800480a:	2b00      	cmp	r3, #0
 800480c:	d135      	bne.n	800487a <_puts_r+0x9a>
 800480e:	4621      	mov	r1, r4
 8004810:	4628      	mov	r0, r5
 8004812:	f7ff ff8f 	bl	8004734 <__swsetup_r>
 8004816:	b380      	cbz	r0, 800487a <_puts_r+0x9a>
 8004818:	f04f 35ff 	mov.w	r5, #4294967295	@ 0xffffffff
 800481c:	6e63      	ldr	r3, [r4, #100]	@ 0x64
 800481e:	07da      	lsls	r2, r3, #31
 8004820:	d405      	bmi.n	800482e <_puts_r+0x4e>
 8004822:	89a3      	ldrh	r3, [r4, #12]
 8004824:	059b      	lsls	r3, r3, #22
 8004826:	d402      	bmi.n	800482e <_puts_r+0x4e>
 8004828:	6da0      	ldr	r0, [r4, #88]	@ 0x58
 800482a:	f7fb fe53 	bl	80004d4 <__retarget_lock_release_recursive>
 800482e:	4628      	mov	r0, r5
 8004830:	bd70      	pop	{r4, r5, r6, pc}
 8004832:	2b00      	cmp	r3, #0
 8004834:	db15      	blt.n	8004862 <_puts_r+0x82>
 ...
 8004840:	f816 1f01 	ldrb.w	r1, [r6, #1]!
 8004844:	3b01      	subs	r3, #1
 8004846:	60a3      	str	r3, [r4, #8]
 8004848:	2900      	cmp	r1, #0
 800484a:	d1f2      	bne.n	8004832 <_puts_r+0x52>
 800484c:	2b00      	cmp	r3, #0
 800484e:	da16      	bge.n	800487e <_puts_r+0x9e>
 8004850:	4622      	mov	r2, r4
 8004852:	210a      	movs	r1, #10
 8004854:	4628      	mov	r0, r5
 8004856:	f7ff ff2f 	bl	80046b8 <__swbuf_r>
 800485a:	3001      	adds	r0, #1
 800485c:	d0dc      	beq.n	8004818 <_puts_r+0x38>
 800485e:	250a      	movs	r5, #10
 8004860:	e7dc      	b.n	800481c <_puts_r+0x3c>
 8004862:	69a2      	ldr	r2, [r4, #24]
 8004864:	429a      	cmp	r2, r3
 8004866:	dc01      	bgt.n	800486c <_puts_r+0x8c>
 8004868:	290a      	cmp	r1, #10
 800486a:	d1e4      	bne.n	8004836 <_puts_r+0x56>
 800486c:	4622      	mov	r2, r4
 800486e:	4628      	mov	r0, r5
 8004870:	f7ff ff22 	bl	80046b8 <__swbuf_r>
 8004874:	3001      	adds	r0, #1
 8004876:	d1e2      	bne.n	800483e <_puts_r+0x5e>
 8004878:	e7ce      	b.n	8004818 <_puts_r+0x38>
 800487a:	3e01      	subs	r6, #1
 800487c:	e7df      	b.n	800483e <_puts_r+0x5e>
 800487e:	6823      	ldr	r3, [r4, #0]
 8004880:	1c5a      	adds	r2, r3, #1
 8004882:	6022      	str	r2, [r4, #0]
 8004884:	220a      	movs	r2, #10
 8004886:	701a      	strb	r2, [r3, #0]
 8004888:	e7e9      	b.n	800485e <_puts_r+0x7e>
	...
...
0800488c <puts>:
 ...
 8004892:	f7ff bfa5 	b.w	80047e0 <_puts_r>
 8004896:	bf00      	nop
...
080048a8 <__swhatbuf_r>:
 ...
 80048d8:	f000 f848 	bl	800496c <_fstat_r>
 80048dc:	2800      	cmp	r0, #0
 80048de:	dbec      	blt.n	80048ba <__swhatbuf_r+0x12>
 80048e0:	9901      	ldr	r1, [sp, #4]
 80048e2:	f401 4170 	and.w	r1, r1, #61440	@ 0xf000
 80048e6:	f5a1 5300 	sub.w	r3, r1, #8192	@ 0x2000
 80048ea:	4259      	negs	r1, r3
 80048ec:	4159      	adcs	r1, r3
 80048ee:	f44f 6380 	mov.w	r3, #1024	@ 0x400
 80048f2:	e7eb      	b.n	80048cc <__swhatbuf_r+0x24>

080048f4 <__smakebuf_r>:
 80048f4:	898b      	ldrh	r3, [r1, #12]
 80048f6:	b5f7      	push	{r0, r1, r2, r4, r5, r6, r7, lr}
 80048f8:	079d      	lsls	r5, r3, #30
 80048fa:	4606      	mov	r6, r0
 80048fc:	460c      	mov	r4, r1
 80048fe:	d507      	bpl.n	8004910 <__smakebuf_r+0x1c>
 8004900:	f104 0347 	add.w	r3, r4, #71	@ 0x47
 ...
 8004910:	ab01      	add	r3, sp, #4
 8004912:	466a      	mov	r2, sp
 8004914:	f7ff ffc8 	bl	80048a8 <__swhatbuf_r>
 8004918:	9f00      	ldr	r7, [sp, #0]
 800491a:	4605      	mov	r5, r0
 800491c:	4639      	mov	r1, r7
 800491e:	4630      	mov	r0, r6
 8004920:	f7fb feb8 	bl	8000694 <_malloc_r>
 8004924:	b948      	cbnz	r0, 800493a <__smakebuf_r+0x46>
 8004926:	f9b4 300c 	ldrsh.w	r3, [r4, #12]
 800492a:	059a      	lsls	r2, r3, #22
 800492c:	d4ee      	bmi.n	800490c <__smakebuf_r+0x18>
 800492e:	f023 0303 	bic.w	r3, r3, #3
 8004932:	f043 0302 	orr.w	r3, r3, #2
 8004936:	81a3      	strh	r3, [r4, #12]
 8004938:	e7e2      	b.n	8004900 <__smakebuf_r+0xc>
 ...
 8004946:	e9c4 0704 	strd	r0, r7, [r4, #16]
 800494a:	b15b      	cbz	r3, 8004964 <__smakebuf_r+0x70>
 800494c:	f9b4 100e 	ldrsh.w	r1, [r4, #14]
 8004950:	4630      	mov	r0, r6
 8004952:	f000 f81d 	bl	8004990 <_isatty_r>
 8004956:	b128      	cbz	r0, 8004964 <__smakebuf_r+0x70>
 ...
 8004966:	431d      	orrs	r5, r3
 8004968:	81a5      	strh	r5, [r4, #12]
 800496a:	e7cf      	b.n	800490c <__smakebuf_r+0x18>
...
0800496c <_fstat_r>:
 ...
 800497a:	f7fc f9f0 	bl	8000d5e <_fstat>
 ...
 800498a:	bf00      	nop
 800498c:	200001c4 	.word	0x200001c4
...
08004990 <_isatty_r>:
 ...
 800499c:	f7fc f9ef 	bl	8000d7e <_isatty>
 ...
 80049ac:	200001c4 	.word	0x200001c4
